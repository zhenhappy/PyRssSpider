...
class RSS2(WriteXmlMixin):
    ...
    rss_attrs = {"xmlns:content": "http://purl.org/rss/1.0/modules/content/",
    ...
    def __init__(self,
        ...
        self.title = title
        self.link = link
        self.atom_link_attrs['href'] = atom_link
        self.description = description
    ...
    def publish(self, handler):
        ...
        _element(handler, "title", self.title)
        _element(handler, "link", self.link)
        handler.startElement("atom:link", self.atom_link_attrs)
